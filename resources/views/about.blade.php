...
<head>
    <title>EduWily Education Category Bootstrap Responsive Web Template | About :: W3layouts</title>
    <!-- Meta tag Keywords -->
    ...
    <section class="about py-5">
        <div class="container py-md-5">
            <div class="about-w3ls-info text-center mx-auto">
                ...
                <a href="/single" class="btn btn-primary submit">Read More</a>
            </div>
        </div>
    </section>
    <!-- //about -->
        ...
        <div class="container py-md-3 text-center">
            <div class="last-lavi-inner-content px-lg-5">
                ...
                <div class="buttons mt-md-4 mt-3">
                    ...
                    <a href="/contact" class="btn btn1"> Hire Us </a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-7 welcome-right text-center mt-lg-0 mt-5">
                    <div class="row">
                        ...
                        <div class="col-sm-4 service-1-w3ls serve-gd3">
                            ...
                            <div class="serve-grid team-gd mt-4">
                                <img src="images/t5.jpg" alt="" class="img-fluid image1">
                                <p class="mt-3">Professor 5</p>
                            </div>
                        </div>
                        <div class="col-sm-4 service-1-w3ls serve-gd2">
                            <div class="serve-grid team-gd mt-4">
                                <img src="images/t6.jpg" alt="" class="img-fluid image1">
